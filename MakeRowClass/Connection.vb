...
#Region "コンストラクタ"
        ...
        Public Sub New(ByVal strConnStr As String, ByVal enmProvider As enmProvider)
            ...
            Catch ex As Exception
                MessageBox.Show(ex.Message, "Connection.New")
            End Try
...
#Region "メソッド"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Overloads Function CreateCommand(ByVal strCommandText As String, ByVal transaction As DbTransaction) As DbCommand
        ...
        Public Sub Close()
            ...
            Try
                ...
                End If
            Catch ex As Exception
                MessageBox.Show(ex.Message, "Connection.Close")
            End Try
