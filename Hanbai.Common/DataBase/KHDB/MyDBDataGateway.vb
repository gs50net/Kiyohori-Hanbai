...
Namespace DataBase.MyDB
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public MustInherit Class MyDBDataGateway : Inherits DataGateway
...
#Region "ID 自動生成"
        ...
        Public Function GetNextId() As Integer
            ...
            If (Genarator Is Nothing) Then
                Genarator = New IDGenerator(mstrTBLID, CClsSetting.GetInstance.pstrKHDBConn, enmProvider.SQLServer)
            End If
