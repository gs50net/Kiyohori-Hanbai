...
#Region "コンストラクタ"
        ...
        Protected Sub New(ByVal dstGateway As DataSetGateway, Optional ByVal strTableName As String = "")
            ...
            If dstGateway Is Nothing Then
                Message.ErrorMessage("dstGateway is Nothing", "DataGateway.New")
            End If
...
#Region "プロパティ"
        ...
        Protected Sub New(p1 As Object, strTableName As String)
...
#Region "メソッド"
        ...
        Public Shared Sub CopyItem(ByVal rowTerget As DataRow, ByVal src As DataRow)
            ...
            For i As Integer = 0 To tblTerget.Columns.Count - 1
                ...
                'End If
                Dim srcClm As DataColumn = src.Table.Columns(strColumnName)
                If Not IsNothing(srcClm) AndAlso srcClm.ReadOnly = False Then
                    rowTerget.Item(i) = src.Item(strColumnName)
                End If
            Next i
